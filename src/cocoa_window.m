...
// by hand.
//
// The handle is the plain C struct declared in cocoa_window.h — NOT an
...
/// that is B, G, R, A — which is exactly what platform/blit.zig produces.
...
- (void)drawRect:(NSRect)dirtyRect {
    ...
    if (o->bitmap_ctx && o->buf_w > 0 && o->buf_h > 0) {
        ...
        if (img) {
            ...
            // platform/blit.zig), and a non-flipped context's origin is also
