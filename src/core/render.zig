...
//!
//! The selection itself lives in `platform.zig` (the composition root) and
//! reaches core through `select.zig`; this file holds no OS branch of its own.
//! Keeping the branch out of here is what lets every core module above it stay
//! platform-blind.
...
/// step.
pub const Renderer = select.Renderer;
