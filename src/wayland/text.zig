...
//
// Backend: pangocairo via src/pango_text.h shim (PangoLayout) with
...
// src/pango_text.c (system compiler). Links from build.zig linkTextEngine().
...
/// Pub because render_gles3.zig must use the identical family for draw.
